    ...
    fullContent: (
        <div>
            ...
            <Figure>
                ...
                <figcaption>Peterson Cottage fireplace lounge chairs, shorter, wider, more reclined versions of the dining chairs.</figcaption>
            </Figure>
            <Figure>
                <img src="./img/flw-chairs.jpg" alt="Frank Lloyd Wright chairs"/>
                <figcaption>Wright designed chairs from the Clarence Sondern House exhibiting a similar leg design.</figcaption>
            </Figure>
            <p>
                Bruce Gueswel (the man often referenced as the designer of the Chipotle chair) built a copy of this chair that became the model for the <a href="http://www.oixio.com/habitat-solutions/form/form-chair.html"><em>for<u>m</u> chair</em></a> designed by Steve Sauer. Sauer took the plywood leg pieces from the original chair and redesigned them in skeletal, galvanized steel. Sauer also widened the base to improve stability. The apex bends in the metal converge under the seatpan in the for<u>m</u>, a divergence from the original design. The chair's name is stylized as for<u>m</u>, with only the "m" underlined.
            </p>
            <Figure>
            ...
            <p>
                These chairs were put into production for the first 7 Chipotle locations, with a run of 244 examples. The chairs were quite noisy, so Ells asked Sauer to design feet to quite them. At this point, Gueswel took over the design and manufacture of the chairs, adding feet and rubber components under the seatpan. The distinguishing difference between the Gueswel Chipotle chair and the original for<u>m</u> chair is the shape of the skeletal legs. The current chair dropped the central convergence for two separate leg components connected in the front and back by cross struts.
            </p>
            <p>
                I prefer the for<u>m</u> chair to the Gueswel chair. Due to the outward bend of the rear leg rods, the lines of the chair are dynamic as the viewing angle changes, appearing straight when viewed from the side and curved when viewed from the rear. This is referenced in the stamp Sauer used to identify his chairs. The rear leg is perfectly straight, but when viewing them from behind, the bend is present.
            </p>
            <Figure>
