...
export default {
  ...
  content: (
    <div>
      ...
      <p>
        I first heard about Giardiniera somewhere in 2018-2019 while binging Bon Apetit videos. Brad Leone, king of all things fermented and pickled, made a <a href="https://www.youtube.com/watch?v=QPvLA-egmWA">video on this italian pickled/fermented vegetable medley.</a> I didn't think much of it, I'm not a pickle person and the veggie blend threw me off.
      </p>
      <p>
        I tried it for the first time at <a href="https://warios-beef-and-pork.business.site/">Wario's Beef and Pork</a> on their cold cut and was blown away. I've done other fermentation projects (kombucha mainly), and a friend had sent me a purpose-built fermentation vessel, so I gave it a try.
      </p>
      <p>
        My Giardiniera included
      </p>
      <ul>
        <li>Cauliflower</li>
        <li>Carrots</li>
        ...
        <li>Jalapeno</li>
        <li>Garlic</li>
        <li>Oregano, red pepper flake, celery salt, peppercorns, coriander, fresh bayleaf</li>
      </ul>
      <p>
        I probably should have weighed these as they were going in, but it's really not important. Eyeball it and add more of what you like. The bay leaf was at the recommendation of Brad Leone, he claims that the tannins in the leaf keep the vegetables crunchy.
      </p>
      <p>
      ...
      />
      <p>
        At the end of the fermentation, I added 3 tbsp sugar and a quarter cup of white vinegar. This should mostly stop the fermentation and add a bit more acidity to the giardiniera.
      </p>
      <p>
