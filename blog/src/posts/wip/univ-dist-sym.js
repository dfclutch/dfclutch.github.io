...
export default {
  ...
  content: (
    <>
      ...
      <ul>
        <li>Glen Echo and Dennison Place</li>
      ...
      <p>
        This leaves out a whole section of neighborhoods directly east of the OSU campus. These neighborhoods don't exist as part of the North or South campus areas, so they aren't considered in the symmetry.
      </p>
      ...
      <p>
        Glen Echo gets it's name, and much of it's identity, from it's northern border: the Glen Echo Ravine. A 50' deep ravine, with steep banks cut into shale, and a metro park at the bottom (accessible by a wooden staircase down the side of the ravine from Cliffside Dr). Glen Echo features an array of architectural styles, but most commonly Craftsmans, and some very unique <a href="https://en.wikipedia.org/wiki/Shingle_style_architecture" target="_blank">Shingle Style</a> homes. Glenmawr Ave is a boulevard with benches and stone
      </p>
      <Footnote>
        * - Interestingly, this map doesn't even include neighborhood labels. It's quite sparsingly labeled, though it does include shading for every structure in the district.
      </Footnote>
    </>
  ),
};